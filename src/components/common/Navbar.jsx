        ...
        <div className="hidden items-center gap-x-4 md:flex">
          {
            user && user?.accountType != "Instructor" && (
              <Link to={"/dashboard/cart"} className="relative inline-block">
                ...
                {totalItems > 0 && (
                  <div className="absolute top-0 right-0 transform translate-x-[30%] -translate-y-[50%] flex items-center justify-center h-4 w-4 rounded-full bg-yellow-100">
                    <span className="text-[10px] font-semibold">{totalItems}</span>
                  </div>
                )}
