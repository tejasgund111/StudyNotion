            ...
            <div className="h-[calc(100vh - 5rem)] overflow-y-auto">
                {courseSectionData.map((course, index) => (
                    <div
                        ...
                        onClick={() => handleSectionClick(course._id)} // for one section open at a time
                        key={index}
                    >
                        {/* Section */}
                        <div className="flex flex-row justify-between bg-richblack-600 px-5 py-4">
                            ...
                            <div className="flex items-center gap-3">
                                <span
                                    className={`transition-transform duration-500 ${activeStatus === course._id ? "rotate-180" : "rotate-0"
                                        }`}
                                >
                                    <BsChevronDown />
                                </span>
